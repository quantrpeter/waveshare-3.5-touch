...
print("Animation range: x 0-{}, y 0-{}".format(max_x, max_y))

# Initial render
lv.task_handler()
lv.refr_now(None)

# Fly animation — different X/Y speeds create a diagonal bouncing path
x = 0.0
y = 0.0
dx = 4.0
dy = 2.5
